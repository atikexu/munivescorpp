            	...
            	<h2>Buscar por: </h2>
            	 <form action="generar_cargos_pdf.htm" class="form-generic" method="post"> 
            		...
            		<div>
						...
						<input readonly="readonly" type="text" required="required" name="fecProceso" id="fecProceso" size="10" maxlength="10" title="Fecha de envio" style="width: 120px;" placeholder="Dia/Mes/Año"/>
					</div>
            		<div >
