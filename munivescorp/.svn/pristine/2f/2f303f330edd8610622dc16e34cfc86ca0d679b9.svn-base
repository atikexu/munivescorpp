...
<html lang="en">
    ...
    <body>
        ...
        <div class="content">
            ...
            <h2>Bajar Reporte BBVA Workflow</h2>
		    <form class="form-generic" action="download_reportbbvaworkf.htm" method="POST" onsubmit="return validaFormDownLoad();">
		    	<div>
				...
				<div>
					<label for="smt"> </label>
					<input type="submit" class="boton-default" value="Exportar .Txt" id="smt"/>
				</div>
		    </form>
		    </div>
        </div>
