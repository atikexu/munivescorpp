...
<%@taglib uri="http://www.springframework.org/security/tags" prefix="sec"%>
	...
	<sec:authorize access="hasRole('DI_ADMIN')">
			<li><a class='${fn:substring(menuSelect, 1, 9)=="7"?"on":""}' href="./generar_cargos.htm"><span class="icon-search"></span>Generar Cargos</a></li>
    		<li><a class='${fn:substring(menuSelect, 1, 9)=="8"?"on":""}' href="./generar_etiquetas.htm"><span class="icon-list"></span>Generar Etiquetas</a></li>
