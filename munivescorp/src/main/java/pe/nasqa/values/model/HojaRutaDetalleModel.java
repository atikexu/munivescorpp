...
public class HojaRutaDetalleModel{
	...
	public List<HojaRutaDetalle> getDistribucionXCodBarCierre(String cod) {
		return hojaRutaDetalleDao.getDistribucionXCodBarCierre(cod);
	}
	...
	public List<Object> codbarClienteSeleccionado(String cod,Integer idRendicion){
		return hojaRutaDetalleDao.codbarClienteSeleccionado(cod,idRendicion);
	}
	
	@Transactional
	public List<Object> existeRendicionXCodBar(String cod){
		return hojaRutaDetalleDao.existeRendicionXCodBar(cod);
	}
	
	@Transactional
	public void updateDetalleCargaXID(Integer id_ruta, String codbar){
		hojaRutaDetalleDao.updateDetalleCargaXID(id_ruta,codbar);
	}
	
	@Transactional
	public List<Object> getHojaRutaXCodBarIdRuta(String codigo,Integer idRuta){
		return hojaRutaDetalleDao.getHojaRutaXCodBarIdRuta(codigo,idRuta);
	}
}
