...
<%--             </c:if> --%>
        	...
        	<div style="text-align: center; margin-left:100px;">
	            ...
	            <c:if test="${estadoCodBar}">
		        	<div style="text-align: center">  
							<label for="smt" style="color:red;">Codigo de barra no está en hoja de ruta</label>
		            </div>
	            </c:if>
	            <div>
...
// 				});
       ...
       $("#btnGuardar").click(function() {//para masivos
    	   ...
    	   var listRutas = {
            ...
            console.log("tamaño de tabla: "+size);   
           for(i = 1; i <= size; i++){
           ...
           if(estado==0){
               ...
               $.ajax({
                  ...
                  data : { 
               	   ...
               	   console.log("actualizó "+data.cargados);
