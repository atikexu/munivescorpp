        ...
        <div class="content">
            ...
            <div class="content-frame-generic">
            	...
            	<div style="text-align: center; padding: 20px;">
           			<a class="boton-link" href="consulta_coord_telf.htm">Ver Gestiones Telef&oacute;nicas</a>
           		</div>
            </div>
            -->
            ...
            <div class="content-result">
	        	...
	        	<table>
	        		<thead>
	        		<tr>
	        			<td style="min-width: 80px;">Fecha de registro de coordinación</td>
	        			<td style="min-width: 80px;">Fecha Coordinada</td>
	        			<td style="min-width: 80px;">Hora Coordinada</td>
	        			<td>Tipo Dir.</td>
	        		...
	        		<c:forEach items="${RPConsultaDetalleCoordinaciones}" var="coord" varStatus="rowCounter">
	        			<tr class='<c:if test="${rowCounter.count % 2 == 0}">on</c:if>'>
	        				<td class="td-center">
		        				<fmt:formatDate var="tempRowFecReg" value="${coord.fecReg}" pattern="dd/MM/yyyy"/>
	        				...
	        				<c:if test="${canDownload==coord.id }">	        					
	        					<td class="td_opt">
		        					<a href="downloadUnoPDFCoord.htm?param=${canDownload}">
										<img alt="download" width="50px" height="50px" src="../static/img/pdf-icon.png">
									</a>
	        					</td>	        		
	        				</c:if>		
	        			</tr>
