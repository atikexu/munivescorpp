        ...
        <div class="content">
            <div class="content-frame-generic">
				...
				<div>
					...
					<span class="value">${SAConsultaDetalle.titTlfLab!=""?SAConsultaDetalle.titTlfLab:"" }</span>
				</div>
				<div>
            ...
            <div class="content-frame-generic">
            	...
            	<br/>
           		...
           		<c:if test="${USUARIO_TIPO == 'DI' || ID_CLIENTE == '0035'}">
	           		<div>
           		...
           		<div style="text-align: center; padding: 20px;">
           			<a class="boton-default" href="consulta_coord.htm">Coordinaciones</a>
           			<a class="boton-default" href="consulta_coord_telf.htm">Gest. Telef&oacute;nica</a>
           		</div>
