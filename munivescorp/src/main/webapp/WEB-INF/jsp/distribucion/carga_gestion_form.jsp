    ...
    <body onload="$('#codBar').select();">
        ...
        <div class="content">
            <div class="content-form-generic">
            	...
            	<form action="consulta_buscar_gestion.htm" class="form-generic" method="post">
            		 
            		<c:if test="${(USUARIO_TIPO=='DI') || ( (USUARIO_TIPO=='CL') && (CLIENTE_CONFIG_CONSRVPAQ=='1') )}">
            		<div hidden="" style="font-style: italic;">
            		...
            		<div hidden="" id="divInputDocIde" style="${tipoBuscar=='PQ'?'display:none;':'' }">
	        	...
	        	<table>
	        		...
	        		<c:forEach items="${resultadoBusqueda}" var="dist" varStatus="rowCounter">
	        			<tr class='<c:if test="${rowCounter.count % 2 == 0}">on</c:if>'>
	        				...
	        				<td class="td-center">
	        					<a href='consulta_detalle.htm?codBar=<c:out value="${dist.codBar}"/>'><samp class=" icon-zoom-in"></samp> Ver detalles</a>
