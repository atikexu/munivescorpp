    ...
    <body onload="$('#ordPro').select();">
        ...
        <div class="content">
            <div class="content-form-generic">
            	<h2>B&uacute;squeda por OP</h2>
            	<form action="reporte_busqueda_op.htm" class="form-generic" method="post" onsubmit="return validaFormBusquedaOp();">
            ...
            <div class="content-form-generic">
            	...
            	<form action="reporte_busqueda_fecha.htm" class="form-generic" method="post" onsubmit="return validaFormBusquedaFecha();">
            		<div style="text-align: center;">
            		...
            		<div>
            			<label for="smt"> </label>
						<input type="submit" class="boton-default" style="min-width: 130px;" value="Consultar" id="smt_fecha"/>
					</div>
            	</form>
            </div>
            ...
            <div class="content-form-generic" style="width: 100%;">
	        	...
	        	<form action="reporte_download.htm" method="post" name="fm_down">
            	<table>
            		<thead>
            			<tr>
