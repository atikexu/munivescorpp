...
<html lang="en">
    ...
    <body>
        ...
        <div class="content">
            ...
            <h2>Bajar Reporte BBVA Pendientes</h2>
		    <form class="form-generic" action="download_reportbbvapendXls.htm" method="POST" onsubmit="return validaFormDownLoad();">
		    	<div>
		    		...
		    		<span><c:if test="${error != null}">Error interno al descargar el archivo</c:if></span>
		    		 <span><c:if test="${finall != null}"> <p> <c:out value="${finall}"/><p> hhhhhhh</c:if></span>
		  ...
		  <form class="form-generic" action="download_reportbbvapendTxt.htm" method="POST" onsubmit="return validaFormDownLoad();">
		    <div>
					<label for="smt2"> </label>
					<input type="submit" class="boton-default" value="Exportar .txt" id="smt2"/>
				</div>
