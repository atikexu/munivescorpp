    ...
    <body onload="$('#codBar').select();">
        ...
        <div class="content">         
       		 ...
       		 <h2> &nbsp; </h2>
       			<form action="generar_ruta.htm" class="form-generic" method="post">
            		<div>
						...
						<input required="required" readonly="readonly" type="text" value="${not empty RPRuta?RPRuta.fecha:fecha}" required="required" name="fecha" id="fecha" size="10" maxlength="10" title="Fecha" style="width: 120px;" placeholder="Dia/Mes/Año"/>
					</div>
					<div>
            	...
            	<div id="divNuevaHoja"> 
            		...
            		<input required="required" readonly="readonly" type="text" value="${not empty RPRuta?RPRuta.fecha:fecha}" required="required" name="fecha" id="fecha" size="10" maxlength="10" title="Fecha" style="width: 120px;" placeholder="Dia/Mes/Año" hidden=""/>
     		...
     		<c:if test="${generar}">
       		 <div class="content-frame-generic">
            		...
            		<div>
						<label for="fecha">Fecha:</label>
						<input required="required" readonly="readonly" type="text" value="${not empty RPRuta?RPRuta.fecha:fecha}" required="required" name="fecha" id="fecha" size="10" maxlength="10" title="Fecha" style="width: 120px;" placeholder="Dia/Mes/Año" onchange="listarRutas()" disabled/>
					</div>
					<div>
            			<label for="ruta">Ruta:</label>
