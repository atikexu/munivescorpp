    ...
    <body>
        ...
        <div class="content">
		    ...
		    <form class="form-login" action="try-register.htm" method="POST">
		    	<div>
		    		<span><c:if test="${error}">Ingrese sus datos correctamente</c:if></span>
		    	</div>
		    	<div>
		    		<span><c:if test="${success}">Sus datos fueron <b>registrado correctamente</b>, en breve el administrador debe generarle su usuario, perfil y darle de alta. </c:if></span>
		    	</div>
...
<!-- 				</div> -->
				...
				<div style="padding-top: 24px;">
					<input type="submit" class="boton-default" value="Solicitar Cuenta" id="smt"/>
				</div>
		    </form>
		    </div>
        </div>
