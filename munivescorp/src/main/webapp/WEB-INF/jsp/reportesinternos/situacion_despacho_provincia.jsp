...
<html lang="en">
    ...
    <body>
        ...
        <div class="content">
            ...
            <h2>Bajar Reporte Situación Despacho a Provincia</h2>
		    <form class="form-generic" action="download_situacion_despacho_provincia.htm" method="POST" onsubmit="return validaFormDownLoad();">
		    	<div>
