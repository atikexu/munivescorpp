...
<html lang="en">
    ...
    <body>
        ...
        <div class="content">
            ...
            <h2>Bajar Reporte Movimiento por Mensajero</h2>
		    <form class="form-generic" action="download_movimiento_mensajero.htm" method="POST" onsubmit="return validaFormDownLoad();">
		    	<div>
