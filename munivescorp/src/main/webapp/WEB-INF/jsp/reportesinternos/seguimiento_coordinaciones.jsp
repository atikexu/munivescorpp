...
<html lang="en">
    ...
    <body>
        ...
        <div class="content">
            ...
            <h2>Bajar Reporte Seguimiento de Coordinaciones</h2>
		    <form class="form-generic" action="download_seguimiento_coordinaciones.htm" method="POST" onsubmit="return validaFormDownLoad();">
		    	<div>
