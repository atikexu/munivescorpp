...
<html lang="en">
    ...
    <body>
        ...
        <div class="content">
            ...
            <h2>Bajar Reporte Resumen de Hoja de Ruta</h2>
		    <form class="form-generic" action="download_resumen_hoja_ruta.htm" method="POST" onsubmit="return validaFormDownLoad();">
		    	<div>
