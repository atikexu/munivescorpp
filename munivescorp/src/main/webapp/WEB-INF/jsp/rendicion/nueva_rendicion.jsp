       		 ...
       		 <h2> &nbsp; </h2>
       			<form action="generar_rendicion.htm" class="form-generic" method="post">
            		...
            		<div>
						...
						<input required="required" type="text" value="${not empty RPRuta?RPRuta.fecha:fecha}" required="required" name="fecha" id="fecha" size="10" maxlength="10" title="Fecha" style="width: 120px;" placeholder="Dia/Mes/Año"/ disabled>
					</div>
